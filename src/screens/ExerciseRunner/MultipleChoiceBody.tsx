...
/**
 * `multiple_choice` body. Option-card visual language adapted from
 * QuizExercise.tsx (rounded card, colored border + ✓/✗ icon on feedback) —
 * visual reuse only, the data model and grading are entirely different
 * (server-graded here, see src/api/exercises.ts).
 */
export function MultipleChoiceBody({ display, disabled, verdict, onAnswerChange }: ExerciseBodyProps) {
