// ---------------------------------------------------------------------------
// MIRRORED FILE — keep byte-identical to the kernel below the header.
// Source: ssz-platform/packages/shared-kernel/src/audio/model.ts
// This repository cannot depend on that one (it is built alone), and the rules
// of the listening layer must be the same rules on the phone as on the server.
// ---------------------------------------------------------------------------
